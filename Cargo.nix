...
args @ {
  ...
  nixifiedLockHash = "1d797dd458cceffc048b80f70845715ca40f38cca1a2b2cb2028d3d7b62a0ec8";
  workspaceSrc =
...
in
  ...
  in {
    ...
    "registry+https://github.com/rust-lang/crates.io-index".async-compression."0.4.10" = overridableMkRustCrate (profileName: rec {
      ...
      src = fetchCratesIo {
        inherit name version;
        sha256 = "9c90a406b4495d129f00461241616194cb8a032c8d1c53c657f0961d5f8e0498";
      };
      features = builtins.concatLists [
        ["flate2"]
        ["gzip"]
    ...
    "registry+https://github.com/rust-lang/crates.io-index".async-process."1.8.1" = overridableMkRustCrate (profileName: rec {
      ...
      dependencies = {
        ...
        ${
          ...
          (rustPackages."registry+https://github.com/rust-lang/crates.io-index".blocking."1.6.0" {inherit profileName;}).out;
        cfg_if = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."1.0.0" {inherit profileName;}).out;
    ...
    "registry+https://github.com/rust-lang/crates.io-index".blocking."1.6.0" = overridableMkRustCrate (profileName: rec {
      ...
      src = fetchCratesIo {
        inherit name version;
        sha256 = "495f7104e962b7356f0aeb34247aca1fe7d2e783b346582db7f2904cb5717e88";
      };
      dependencies = {
    ...
    "registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.83" = overridableMkRustCrate (profileName: rec {
      ...
      src = fetchCratesIo {
        inherit name version;
        sha256 = "0b33eb56c327dec362a9e55b3ad14f9d2f0904fb5a5b03b513ab5465399e9f43";
      };
      features = builtins.concatLists [
        ["default"]
        ["proc-macro"]
    ...
    "registry+https://github.com/rust-lang/crates.io-index".reqwest."0.11.27" = overridableMkRustCrate (profileName: rec {
      ...
      dependencies = {
        ${
          ...
          (rustPackages."registry+https://github.com/rust-lang/crates.io-index".async-compression."0.4.10" {inherit profileName;}).out;
        base64 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".base64."0.21.7" {inherit profileName;}).out;
        bytes = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.6.0" {inherit profileName;}).out;
        ${
          if !(hostPlatform.parsed.cpu.name == "wasm32")
    ...
    "registry+https://github.com/rust-lang/crates.io-index".reqwest."0.12.4" = overridableMkRustCrate (profileName: rec {
      ...
      dependencies = {
        ...
        ${
          ...
          (rustPackages."registry+https://github.com/rust-lang/crates.io-index".hyper-util."0.1.3" {inherit profileName;}).out;
        ${
          if !(hostPlatform.parsed.cpu.name == "wasm32")
          then "ipnet"
          else null
    ...
    "registry+https://github.com/rust-lang/crates.io-index".serde."1.0.202" = overridableMkRustCrate (profileName: rec {
      ...
      src = fetchCratesIo {
        inherit name version;
        sha256 = "226b61a0d411b2ba5ff6d7f73a476ac4f8bb900373459cd00fab8512828ba395";
      };
      features = builtins.concatLists [
        ["alloc"]
        ["default"]
    ...
    "registry+https://github.com/rust-lang/crates.io-index".serde_derive."1.0.202" = overridableMkRustCrate (profileName: rec {
      ...
      src = fetchCratesIo {
        inherit name version;
        sha256 = "6048858004bcff69094cd972ed40a32500f153bd3be9f716b2eed2e8217c4838";
      };
      features = builtins.concatLists [
        ["default"]
      ];
