...
let
  nixifiedLockHash = "bbe73636cca176b2f2ac14f3dd2fba08ba494ed5232cc7f754d4ca1b1d9757c5";
...
if !lockHashIgnored && (nixifiedLockHash != currentLockHash) then
  ...
  in
  {
    ...
    "registry+https://github.com/rust-lang/crates.io-index".clap."4.5.33" =
      overridableMkRustCrate
        (profileName: rec {
          name = "clap";
          version = "4.5.33";
          ...
          dependencies = {
            clap_builder =
              (rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap_builder."4.5.33" {
                inherit profileName;
              }).out;
            clap_derive =
    ...
    "registry+https://github.com/rust-lang/crates.io-index".clap_builder."4.5.33" =
      overridableMkRustCrate
        (profileName: rec {
          name = "clap_builder";
          version = "4.5.33";
    ...
    "registry+https://github.com/rust-lang/crates.io-index".cxxbridge-cmd."1.0.151" =
      overridableMkRustCrate
        (profileName: rec {
          ...
          dependencies = {
            clap =
              (rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."4.5.33" {
                inherit profileName;
              }).out;
            codespan_reporting =
              (rustPackages."registry+https://github.com/rust-lang/crates.io-index".codespan-reporting."0.12.0" {
