...
let
  nixifiedLockHash = "050c744d82a1c22cee0cefd8fd3c76fe49dfd165a654d6aa3e3d0c94583f9da3";
...
if !lockHashIgnored && (nixifiedLockHash != currentLockHash) then
  ...
  in
  {
    ...
    "registry+https://github.com/rust-lang/crates.io-index".bstr."1.12.0" =
      overridableMkRustCrate
        (profileName: rec {
          name = "bstr";
          version = "1.12.0";
      ...
      overridableMkRustCrate
        (profileName: rec {
          ...
          dependencies = {
            ...
            half =
              (rustPackages."registry+https://github.com/rust-lang/crates.io-index".half."2.6.0" {
                inherit profileName;
              }).out;
          };
        });
    ...
    "registry+https://github.com/rust-lang/crates.io-index".cxx."1.0.157" =
      overridableMkRustCrate
        (profileName: rec {
          name = "cxx";
          version = "1.0.157";
          ...
          src = fetchCratesIo {
            inherit name version;
            sha256 = "3d6354e975ea4ec28033ec3a36fa9baa1a02e3eb22ad740eeb4929370d4f5ba8";
          };
          features = builtins.concatLists [
            [ "alloc" ]
            [ "default" ]
          ...
          dependencies = {
            cxxbridge_macro =
              (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cxxbridge-macro."1.0.157"
                { profileName = "__noProfile"; }
              ).out;
            foldhash =
          ...
          buildDependencies = {
            ...
            cxxbridge_flags =
              (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cxxbridge-flags."1.0.157"
                { profileName = "__noProfile"; }
              ).out;
          };
        });

    "registry+https://github.com/rust-lang/crates.io-index".cxx-gen."0.7.157" =
      overridableMkRustCrate
        (profileName: rec {
          name = "cxx-gen";
          version = "0.7.157";
          ...
          src = fetchCratesIo {
            inherit name version;
            sha256 = "cb2fe813ed9cce582f1e5af26763ae190f60a89b1dcf5209059591c449af3e27";
          };
          dependencies = {
            codespan_reporting =
    ...
    "registry+https://github.com/rust-lang/crates.io-index".cxx-qt."0.7.1" =
      overridableMkRustCrate
        (profileName: rec {
          ...
          dependencies = {
            cxx =
              (rustPackages."registry+https://github.com/rust-lang/crates.io-index".cxx."1.0.157" {
                inherit profileName;
              }).out;
            cxx_qt_macro =
      ...
      overridableMkRustCrate
        (profileName: rec {
          ...
          dependencies = {
            ...
            cxx_gen =
              (rustPackages."registry+https://github.com/rust-lang/crates.io-index".cxx-gen."0.7.157" {
                inherit profileName;
              }).out;
            cxx_qt_gen =
    ...
    "registry+https://github.com/rust-lang/crates.io-index".cxxbridge-cmd."1.0.157" =
      overridableMkRustCrate
        (profileName: rec {
          name = "cxxbridge-cmd";
          version = "1.0.157";
          ...
          src = fetchCratesIo {
            inherit name version;
            sha256 = "31860c98f69fc14da5742c5deaf78983e846c7b27804ca8c8319e32eef421bde";
          };
          dependencies = {
            clap =
              (rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."4.5.36" {
    ...
    "registry+https://github.com/rust-lang/crates.io-index".cxxbridge-flags."1.0.157" =
      overridableMkRustCrate
        (profileName: rec {
          ...
          src = fetchCratesIo {
            inherit name version;
            sha256 = "b0402a66013f3b8d3d9f2d7c9994656cc81e671054822b0728d7454d9231892f";
          };
          features = builtins.concatLists [
            [ "default" ]
          ];
    ...
    "registry+https://github.com/rust-lang/crates.io-index".cxxbridge-macro."1.0.157" =
      overridableMkRustCrate
        (profileName: rec {
          ...
          src = fetchCratesIo {
            inherit name version;
            sha256 = "64c0b38f32d68f3324a981645ee39b2d686af36d03c98a386df3716108c9feae";
          };
          dependencies = {
            proc_macro2 =
              (rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.94" {
      ...
      overridableMkRustCrate
        (profileName: rec {
          ...
          dependencies = {
            ...
            bstr =
              (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bstr."1.12.0" {
                inherit profileName;
              }).out;
            log =
              (rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.27" {
    ...
    "registry+https://github.com/rust-lang/crates.io-index".self_cell."0.10.3" =
      overridableMkRustCrate
        (profileName: rec {
          ...
          dependencies = {
            new_self_cell =
              (rustPackages."registry+https://github.com/rust-lang/crates.io-index".self_cell."1.2.0" {
                inherit profileName;
              }).out;
          };
        });
